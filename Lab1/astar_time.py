...
def astar_time(start_node, end_node, neighbors_fn):
...
def get_shortest_path_astar_time(start_node, end_stop):
    graph = Graph()
    came_from, cost = astar_time(start_node, Node(end_stop, None), graph)
